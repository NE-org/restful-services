          ...
          <ul className="space-y-2 flex-1 flex-col flex h-5/6 pb-2">
            <li className='pb-4'>
              <Link href="/" className="font-bold flex items-center lg:ml-2.5">
                <img src="/assets/logo.svg" className="h-6 mr-4" alt="Windster Logo" />
                <Text className="self-center whitespace-nowrap text-xl"><Text className='text-primary text-2xl'>E</Text>-Book</Text>
              </Link>
            </li>
            {
